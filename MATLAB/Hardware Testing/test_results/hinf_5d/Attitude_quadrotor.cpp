 ...
 * Test Configuration: 
 *  - Test Name: hinf_5d
 *  - Outer Loop: Kp = 2.08, Ki = 0, Kd = 0.0276
 *  - Inner Loop: Kp = 0.53, Ki = 0.728, Kd = 0.02, Kb = 0.16575
 *
