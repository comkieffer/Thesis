 ...
 * Test Configuration: 
 *  - Test Name: hinf_4d
 *  - Outer Loop: Kp = 2.15, Ki = 0, Kd = 0.0171
 *  - Inner Loop: Kp = 0.569, Ki = 0.787, Kd = 0.0204, Kb = 0.161
 *
