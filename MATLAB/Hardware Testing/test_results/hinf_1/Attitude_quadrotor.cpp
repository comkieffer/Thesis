 ...
 * Test Configuration: 
 *  - Test Name: hinf_1
 *  - Outer Loop: Kp = 2.12, Ki = 0, Kd = 0.105, N = 15.5280
 *  - Inner Loop: Kp = 0.421, Ki = 0.47, Kd = 0.0387, Kb = 0.28695, N = 4.6296
 *
 * Note: Modified T_f for both loops. 
 *
...
Attitude_quadrotorModelClass::Attitude_quadrotorModelClass()
{
  static const P_Attitude_quadrotor_T Attitude_quadrotor_P_temp = {
    ...
    0.40514779629427244,               /* Variable: KB_P
                                        * Referenced by: '<S6>/Kb'
                                        */
    0.28695,                        /* Variable: KB_Q, Orig: 0.40514779629427244
                                        * Referenced by: '<S7>/Kb'
                                        */
    ...
    0.0499,                            /* Variable: KD_P
                                        ...
                                        */
    0.105,                    /* Variable: KD_PITCH, Orig: 0.00512
                                        * Referenced by: '<S3>/Derivative Gain'
                                        */
    0.0387,                        /* Variable: KD_Q, Orig: 0.0499
    ...
    0.298,                             /* Variable: KP_P
                                        ...
                                        */
    2.12,                    /* Variable: KP_PITCH, Orig: 2.0
                                        * Referenced by: '<S3>/Proportional Gain'
                                        */
    0.421,                        /* Variable: KP_Q:, 0.298
