 ...
 * Test Configuration: 
 *  - Test Name: hinf_3d
 *  - Outer Loop: Kp = 2.08, Ki = 0, Kd = 0.0247
 *  - Inner Loop: Kp = 0.54, Ki = 0.749, Kd = 0.0205, Kb = 0.16544
 *
