 ...
 * 
 * Test Configuration: 
 *  - Test Name: test_i8_di09_o4_do09_full_batt
 *  - Outer Loop: Kp = 1.7885, Ki = 0, Kd = 0
 *  - Inner Loop: Kp = 0.28872, Ki = 0.86184, Kd = 0, Kb = 0
 *
...
Attitude_quadrotorModelClass::Attitude_quadrotorModelClass()
{
  static const P_Attitude_quadrotor_T Attitude_quadrotor_P_temp = {
    ...
    0,                    /* Variable: KI_PITCH, Orig: 0.0
                                        ...
                                        */
    0.86184,                        /* Variable: KI_Q, Orig: 0.304
    ...
    0.298,                             /* Variable: KP_P
                                        ...
                                        */
    1.7885,                    /* Variable: KP_PITCH, Orig: 2.0
                                        * Referenced by: '<S3>/Proportional Gain'
                                        */
    0.28872,                        /* Variable: KP_Q:, 0.298
